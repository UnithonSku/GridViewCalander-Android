package com.example.c2619.myapplication;

/**
 * Created by c2619 on 2018-01-07.
 */
...
//      int width = mContext.getResources().getDisplayMetrics().widthPixels;
        int cellWidth = mContext.getResources().getDisplayMetrics().widthPixels;
...
//      int height = mContext.getResources().getDisplayMetrics().widthPixels;
        int cellHeight = mContext.getResources().getDisplayMetrics().heightPixels/8;
